...
function get_nearest_places($keyword,$ApiKey,$conn,$id)
{
    ...
    $place1 = $place['results'][1]->name.",".$place['results'][1]->opening_hours.",".$place['results'][1]->vicinity;
    $place2 = $place['results'][2]->name.",".$place['results'][2]->opening_hours.",".$place['results'][2]->vicinity;
    return $place,$place1,$place2;
