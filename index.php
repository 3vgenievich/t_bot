...
function get_nearest_places($keyword,$ApiKey,$conn,$id)
{
    ...
    $lat =$res['lat'];
    $lon=$res['lon'];
    $url="https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=".$lat.",".$lon."&radius=2500&type=car_repair&keyword=".$keyword."&key=".$ApiKey;//находит автосервисы в радиусе 5км
